"""Wrapper runner pour services Node.js."""
...
class NodeRunner(RunnerBase):
    def start(self) -> dict:
        working_dir = self.spec.working_dir
        command = self.spec.command or ["node", self.spec.entrypoint or "server.js"]
        ...
        try:
            ...
            if sys.platform == "win32":
                ...
                proc = subprocess.Popen(command, cwd=str(working_dir), start_new_session=True)
